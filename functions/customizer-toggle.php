...
class Customizer_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-toggle-control', get_stylesheet_directory_uri() . '/assets/js/dist/customizer-toggle-control.js', array( 'jquery' ), '', true );
		wp_enqueue_style( 'toggle-buttons', get_stylesheet_directory_uri() . '/assets/css/toggle-buttons.css', array(), '1.3' );
		$css = '
